...
#define TX_MIXED \
  -3 /* transaction was partially committed and partially rolled back */
#define TX_HAZARD                                                           \
  -4 /* transaction may have been partially  committed and partially rolled \
        back */
...
#define TX_NO_BEGIN \
  -100 /* transaction committed plus new transaction could not be started */
#define TX_ROLLBACK_NO_BEGIN                                               \
  (TX_ROLLBACK + TX_NO_BEGIN) /* transaction rollback plus new transaction \
