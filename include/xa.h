...
#define TMRESUME                                   \
  0x08000000L /* caller is resuming association    \
...
#ifndef TM_OK
#define TM_JOIN                               \
  2 /* caller is joining existing transaction \
     * branch                                 \
     */
#define TM_RESUME                                      \
...
#define XA_RBINTEGRITY                                     \
  XA_RBBASE + 3 /* A condition that violates the integrity \
...
#define XA_RETRY                           \
  4 /* routine returned with no effect and \
     ...
     */
#define XA_RDONLY                                                 \
  3                   /* the transaction branch was read-only and \
                       * has been committed                       \
                       */
