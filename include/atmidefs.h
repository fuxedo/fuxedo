...
#define TX_OUTSIDE              \
  -1 /* application is in an RM \
* local transaction */
#define TX_ROLLBACK            \
  -2 /* transaction was rolled \
* back */
#define TX_MIXED          \
  -3 /* transaction was   \
...
#define TX_HAZARD                 \
  -4 /* transaction may have been \
* partially committed and         \
* partially rolled back */
#define TX_PROTOCOL_ERROR                     \
  -5                 /* routine invoked in an \
* improper context */
...
#define TX_NO_BEGIN                  \
  -100 /* transaction committed plus \
